...
RSpec.describe 'Advanced Nested Collections' do
  ...
  it 'test 4' do
    ...
    big_mac_ingredients = stores[:macdonalds][:dishes][1][:ingredients]

    expected = ['Potatoes', 'Salt']
  ...
  it 'test 8' do
    ...
    ingredients = stores.map do |store_name,data|
